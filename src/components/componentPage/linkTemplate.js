...
//Servicii IT / VIRTUALIZATION SOLUTIONS BiLogIn
            ...
            let card = details.map((elem, index) => {
                ...
                if (elem.icon) {
                    ...
                    if (elem.icon.includes('IoCheckmarkDone')) {
                        ...
                        elem.icon.includes('HiOutlineArrowNarrowRight')
                    ) {
                        ...
                        icon = <CgRadioCheck />;
                        //servicii it// Vizualizare
                    } else if (elem.icon.includes('BsBook')) {
                        icon = <BsBook />;
                    } else if (elem.icon.includes('BsArrowRepeat')) {
                        icon = <BsArrowRepeat />;
                    } else if (elem.icon.includes('AiOutlineTag')) {
                        icon = <AiOutlineTag />;
                    } else if (elem.icon.includes('BiLogIn')) {
                        icon = <BiLogIn />;
                    } else if (elem.icon.includes('FiCheckCircle')) {
                        icon = <FiCheckCircle />;
                    } else if (elem.icon.includes('AiOutlineLock')) {
                        icon = <AiOutlineLock />;
                    } else if (elem.icon.includes('BiUpArrowCircle')) {
                        icon = <BiUpArrowCircle />;
                    } else if (elem.icon.includes('BsPersonCheck')) {
                        icon = <BsPersonCheck />;
                    }
                } else {
                    icon = null;
            ...
            <div>
                ...
                <Wraper className='page-header-image'>
                    <div class='background'>
                        <Container>
                            <HeaderTitle className=' fAleg'>
                                {this.state.title}
                            </HeaderTitle>
                            <MiniHeader className=' fAleg'>
                                SYSTEMSOONT SRL
                            </MiniHeader>
                        </Container>
